...
calculateBtn.addEventListener("click", () => {
    ...
    totalMinutesEl.innerText =
        `⏱ Minutes: ${totalMinutes.toLocaleString()}`;

    totalSecondsEl.innerText =
...
resetBtn.addEventListener("click", () => {
    ...
    totalDaysEl.innerText = "📅 Days: 0";
    totalHoursEl.innerText = "⏰ Hours: 0";
    totalMinutesEl.innerText = "⏱ Minutes: 0";
    totalSecondsEl.innerText = "⚡ Seconds: 0";
...
📅 Age: ${yearsEl.innerText} Years, ${monthsEl.innerText} Months, ${daysEl.innerText} Days
...
speakBtn.addEventListener("click", () => {
    ...
    const text =
        `Your age is ${yearsEl.innerText} years, ${monthsEl.innerText} months and ${daysEl.innerText} days. ${birthdayCountdownEl.innerText}.`;
